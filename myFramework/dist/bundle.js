...
var User = /** @class */ (function () {
    ...
    User.prototype.set = function (changes) {
    ...
    User.prototype.fetch = function () {
        axios__WEBPACK_IMPORTED_MODULE_0___default().get("http://localhost:/users/" + this.get('id'));
    };
    return User;
}());
...
var user = new _models_User__WEBPACK_IMPORTED_MODULE_0__.User({ name: 'Aashaya', age: 20 });
console.log(user.get('name'));
user.on('chan', function () {
    console.log('eafds');
});
user.trigger('chan');
